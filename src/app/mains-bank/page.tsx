...
import { addMainsQuestion, fetchMainsQuestions, subscribeMainsQuestions, deleteMainsQuestion, MainsQuestion } from "@/lib/mains-questions";
...
export default function MainsBankAdmin() {
  ...
  useEffect(() => {
     setIsLoading(true);
     const unsubscribe = subscribeMainsQuestions(language, (data) => {
